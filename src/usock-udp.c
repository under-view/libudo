...
/*
 * @brief Structure defining UDO Unix Socket UDP instance.
 *
...
struct udo_usock_udp_create_info
{
...
static int
p_create_sock_fd (struct udo_usock_udp *usock)
{
	const int enable = 1;
...
static struct udo_usock_udp *
p_create_usock (struct udo_usock_udp *p_usock,
                const void UDO_UNUSED *p_usock_info)
{
	struct udo_usock_udp *usock = p_usock;

	if (!usock) {
		usock = calloc(1, sizeof(struct udo_usock_udp));
		if (!usock) {
...
/*******************************************
 * Start of udo_usock_udp_server functions *
 *******************************************/

struct udo_usock_udp *
udo_usock_udp_server_create (struct udo_usock_udp *p_usock,
                             const void *p_usock_info)
{
	int err = -1;

	struct udo_usock_udp *usock = NULL;

	const struct udo_usock_udp_create_info *usock_info = p_usock_info;
                                ...
                                const void *usock_info)
{
	...
	return udo_usock_udp_recv_data(usock->fd, data,
	                         size, addr, usock_info);
}

/*****************************************
 * End of udo_usock_udp_server functions *
 *****************************************/


/*******************************************
 * Start of udo_usock_udp_client functions *
 *******************************************/

struct udo_usock_udp *
udo_usock_udp_client_create (struct udo_usock_udp *p_usock,
                             const void *p_usock_info)
{
	int err = -1;
                                ...
                                const void *usock_info)
{
	...
	return udo_usock_udp_send_data(usock->fd, data, size,
	                            &(usock->saddr), usock_info);
}

/*****************************************
 * End of udo_usock_udp_client functions *
 *****************************************/


/****************************************
 * Start of udo_usock_udp_get functions *
 ****************************************/
...
/**************************************
 * End of udo_usock_udp_get functions *
 **************************************/


/********************************************
 * Start of udo_usock_udp_destroy functions *
 ********************************************/
...
udo_usock_udp_destroy (struct udo_usock_udp *usock)
{
	...
	if (usock->free) {
		...
		memset(usock, 0, sizeof(struct udo_usock_udp));
		usock->fd = -1;
	}
}

/******************************************
 * End of udo_usock_udp_destroy functions *
 ******************************************/


/*****************************************************
 * Start of non struct udo_usock_udp param functions *
 *****************************************************/

int
udo_usock_udp_get_sizeof (void)
{
	return sizeof(struct udo_usock_udp);
}
...
/***************************************************
 * End of non struct udo_usock_udp param functions *
 ***************************************************/
